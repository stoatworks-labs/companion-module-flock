...
**[v1.0.3](https://github.com/stoatworks-labs/companion-module-flock/releases/tag/v1.0.3)**
...
- [`flock-1.0.3.tgz`](https://github.com/stoatworks-labs/companion-module-flock/releases/download/v1.0.3/flock-1.0.3.tgz) — npm package, 25 KB
