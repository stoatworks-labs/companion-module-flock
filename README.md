...
**[v1.0.2](https://github.com/stoatworks-labs/companion-module-flock/releases/tag/v1.0.2)**
...
- [`flock-1.0.2.tgz`](https://github.com/stoatworks-labs/companion-module-flock/releases/download/v1.0.2/flock-1.0.2.tgz) — npm package, 24 KB
